...
# 실습 1-3
INSERT INTO `User1` VALUES ('101','김유신','010-1234-1111',25);
INSERT INTO `User1` VALUES ('102','김춘추','010-1234-2222',23);
INSERT INTO `User1` VALUES ('103','장보고','010-1234-3333',32);
INSERT INTO `User1` (`uid`, `name`,`age`) VALUES ('104','강감찬',45);
INSERT INTO `User1` SET `uid`='A105', `name`='이순신',`hp`='010-1234-5555';
# 실습 1-4
SELECT * FROM `User1`;
SELECT * FROM `User1` WHERE `uid`= '101';
...
UPDATE `User1` SET `hp`='010-1234-1001', `age`=27 WHERE `uid`='101';
# 실습 1-6
DELETE FROM `User1` WHERE `uid`='101';
...
INSERT INTO `TblUser` (`userId`, `userName`,`userAddr`) VALUES ('p104','강감찬','경기도 광주군');
INSERT INTO `TblUser` (`userId`, `userName`,`userHp`,`userAge`) VALUES ('p105','이순신','010-1234-1005',31);
...
INSERT INTO `TblProduct` (`prdCode`, `prdName`,`prdPrice`,`prdAmount`) 
								VALUES (5,'컴퓨터',1100,0);
INSERT INTO `TblProduct` VALUES (6,'휴대폰',990,102,'삼성','2022-01-06');
# 실습 1-9
