...
INSERT INTO `Departments` VALUES (21,'경영학과','051-510-1021');
...
SELECT	`stdNo`,
			...
			b.`depNo`,
			`depName` 
FROM `Students` AS a JOIN `Departments` AS b ON a.depNo = b.depNo;

##실습 -2 모든 교수의 교수번호, 이름, 휴대폰, 학과번호, 학과명을 조회하시오.
...
UPDATE `Register` SET `regAttenSCore` =15,  `regMidScore` = 25, `regFinalScore`= 58 WHERE `stdNo`='20101001' AND `lecNo`='101001';
UPDATE `Register` SET `regAttenSCore` =25,  `regMidScore` = 35, `regFinalScore`= 88 WHERE `stdNo`='20101001' AND `lecNo`='101002';
UPDATE `Register` SET `regAttenSCore` =25,  `regMidScore` = 85, `regFinalScore`= 78 WHERE `stdNo`='20111013' AND `lecNo`='111011';
UPDATE `Register` SET `regAttenSCore` =45,  `regMidScore` = 45, `regFinalScore`= 48 WHERE `stdNo`='21231002' AND `lecNo`='231110';
UPDATE `Register` SET `regAttenSCore` =55,  `regMidScore` = 35, `regFinalScore`= 88 WHERE `stdNo`='22401001' AND `lecNo`='401019';
UPDATE `Register` SET `regAttenSCore` =65,  `regMidScore` = 85, `regFinalScore`= 98 WHERE `stdNo`='22401001' AND `lecNo`='421012';
UPDATE `Register` SET `regAttenSCore` =85,  `regMidScore` = 75, `regFinalScore`= 98 WHERE `stdNo`='20101001' AND `lecNo`='101003';
UPDATE `Register` SET `regAttenSCore` =75,  `regMidScore` = 95, `regFinalScore`= 89 WHERE `stdNo`='22421003' AND `lecNo`='311003';
UPDATE `Register` SET `regAttenSCore` =95,  `regMidScore` = 95, `regFinalScore`= 78 WHERE `stdNo`='22421003' AND `lecNo`='421012';
UPDATE `Register` SET `regAttenSCore` =85,  `regMidScore` = 75, `regFinalScore`= 58 WHERE `stdNo`='20111013' AND `lecNo`='111012';
##실습 - 6 다른방법
UPDATE `Register` SET
